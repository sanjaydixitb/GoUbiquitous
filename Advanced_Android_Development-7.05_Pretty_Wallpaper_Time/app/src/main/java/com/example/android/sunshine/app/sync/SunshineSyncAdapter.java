...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String PATH_WEATHER = "/watch_face/weather";
    private static final String KEY_HIGH = "TEMP_HI";
    private static final String KEY_LOW = "TEMP_LOW";
    ...
    private void sendWeatherToWatchFace() {
        ...
        dataMap.putInt(KEY_HIGH, (int)cursor.getDouble(INDEX_MAX_TEMP));
        dataMap.putInt(KEY_LOW, (int)cursor.getDouble(INDEX_MIN_TEMP));
        dataMap.putInt(KEY_ID, cursor.getInt(INDEX_WEATHER_ID));
        Log.d(LOG_TAG,"Sending hi:" + (int)cursor.getDouble(INDEX_MAX_TEMP) + " lo : " + (int)cursor.getDouble(INDEX_MIN_TEMP) + " id : " + cursor.getInt(INDEX_WEATHER_ID));
        PutDataRequest putDataRequest = mapRequest.asPutDataRequest();
        Wearable.DataApi.putDataItem(googleApiClient, putDataRequest);
        Log.d(LOG_TAG,"Sent data to wearable!");
    }
